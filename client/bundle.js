...
MdFilledTonalButton.styles = [styles$8, styles$9, styles$6];
MdFilledTonalButton = __decorate([
    e$7('md-filled-tonal-button')
], MdFilledTonalButton);
...
MdElevatedButton.styles = [styles$8, styles$9, styles$5];
